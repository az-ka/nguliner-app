        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('crip.store') }}" method="POST">
                        @csrf
                        <div>
                        ...
                        <div>
                            ...
                            <input type="number" name="nilai_crip" name="hs-leading-icon"
                        ...
                        <div class="text-center">
                            <button type="submit"
                                class="inline-block mt-6 rounded bg-indigo-600 px-4 py-2 text-xs font-medium text-white hover:bg-indigo-700">
                                Submit
                            </button>
                        </div>
                    </form>
